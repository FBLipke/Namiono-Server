...
public:
	...
	static EXPORT bool Compare(const char* p1, const char* p2, const _SIZE_T length);

	static EXPORT _SIZE_T Strip(const char* buffer, const _SIZE_T buflen);
	static EXPORT std::string AsString(const _SIZE_T input);
